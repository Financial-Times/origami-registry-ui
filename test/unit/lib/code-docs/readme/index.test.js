...
describe('lib/code-docs/readme/index', () => {
    ...
    const mockV2Component = {
        name: 'o-mock-component',
        origamiVersion: '2.0',
        version: '1.0.0',
        // versionTag is not accurate for v2 components, we intend to deprecate repo data and registry-ui
        versionTag: '1.0.0',
        // url is not accurate for v2 components, we intend to deprecate repo data and registry-ui
        url: 'https://github.com/Financial-Times/o-mock-component'
    };

    describe('v1 component', () => {
        const mockComponentToTest = mockV1Component;

        describe('createNavigation', () => {
            const createNavReadme = new Readme('# H1\n## H2a\n### H3a\nSome actual content.\n## H2b\n## H2c\n#### H4a\n\n### H3b\n### H3c\n## H2d\nMore content.', mockComponentToTest);
        ...
        describe('formatCode', () => {
            ...
            it('formats inline code blocks for o-syntax-hightlight', () => {
                const codeReadme = new Readme('`obt install`', mockComponentToTest);
        ...
        describe('formatAnchors', () => {
            it('formats in-page anchor links as Origami style links', () => {
                const anchorReadme = new Readme('[anchor link](#myanchor)', mockComponentToTest);
            ...
            it('updates href of relative urls to point to GitHub', () => {
                const anchorReadme = new Readme('[relative link](/relative/link)', mockComponentToTest);
            ...
            it('formats absolute anchors as Origami style external links', () => {
                const anchorReadme = new Readme('[relative link](https://google.com)', mockComponentToTest);
            ...
            it('formats absolute anchors as Origami style internal links if the current host matches', () => {
                const anchorReadme = new Readme('[internal link](https://localhost.com)', mockComponentToTest, 'localhost.com');
            ...
            it('does not format anchors which contain an image e.g. the circle ci build image ', () => {
                const anchorReadme = new Readme('[![CircleCI](https://circleci.com/gh/Financial-Times/o-test-component.png)](https://circleci.com/gh/Financial-Times/o-test-component)', mockComponentToTest);
