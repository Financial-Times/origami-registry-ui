...
class JsDocNav {
     ...
     * @returns {Object[]} A navigation composing an array of sub-navigations e.g. [{title, items: [{title, link}]}]
     */
    static createNavigation(doclets) {
        ...
        const nodesByHierarchy = JsDoc.formatWithHierarchy(doclets);
        const docletGroups = [
 ...
 * @returns {Object} A sub-navigation e.g. {title, items: [{title, link}]}
 * @access private
 */
