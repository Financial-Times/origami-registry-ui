...
module.exports = app => {
	...
	const switchBrandAndVersion = (request, response, next) => {
		...
		if (request.query['switch-version'] || request.query['switch-brand']) {
			const switchBrand = request.query['switch-brand'];
			const switchVersion = request.query['switch-version'] || componentVersion;
			// Replace version.
	...
	const findBrand = (request, response, next) => {
		...
		const currentBrand = request.query.brand || defaultBrand;
		...
		const hasStyles = component && component.languages.find((language) => ['css', 'scss', 'sass'].includes(language));
	...
	app.get('/components/:componentId', cacheForFiveMinutes, switchBrandAndVersion, findComponent, findBrand, async (request, response, next) => {
		const component = request.component;
	...
	app.get('/components/:componentId/details', cacheForFiveMinutes, switchBrandAndVersion, findComponent, findBrand, async (request, response, next) => {
		const component = request.component;
		const versions = request.versions;
		const currentBrand = request.currentBrand;
	...
	app.get('/components/:componentId/jsdoc', cacheForFiveMinutes, switchBrandAndVersion, findComponent, findBrand, async (request, response, next) => {
		const component = request.component;
		const versions = request.versions;
		const currentBrand = request.currentBrand;
		let jsDocData;
	...
	app.get('/components/:componentId/sassdoc', cacheForFiveMinutes, switchBrandAndVersion, findComponent, findBrand, async (request, response, next) => {
		const component = request.component;
		const versions = request.versions;
		const currentBrand = request.currentBrand;
		let sassDocData;
	...
	app.get('/components/:componentId/readme', cacheForFiveMinutes, switchBrandAndVersion, findComponent, findBrand, async (request, response, next) => {
		const component = request.component;
		const versions = request.versions;
		const currentBrand = request.currentBrand;
		try {
